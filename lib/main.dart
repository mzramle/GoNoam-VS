...
import 'package:gonoam_v1/features/presentation/pages/voice_synthesis/trained_voice_library_page.dart';
import 'package:gonoam_v1/features/presentation/pages/voice_synthesis/testvoiceFlask.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
            name: '/trained_voice_library_page',
            page: () => const TrainedVoiceLibraryPage()),
        GetPage(
